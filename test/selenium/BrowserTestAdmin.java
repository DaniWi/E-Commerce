...
public class BrowserTestAdmin {
	...
	public void adminRightsTest() {
		...
		buttonCount = driver.findElements(By.className("btn-primary")).size();
		Assert.assertEquals(4, buttonCount);
	...
	public void newItemTest() {
		...
		Assert.assertEquals(bookCount_before + 1, bookCount_after);
		Assert.assertEquals(1, newBookCount);
	}
