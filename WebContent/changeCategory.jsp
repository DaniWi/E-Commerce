...
<html>
	...
	<body id="page_login">
		...
		<div class="container">
			...
			<form class="form-signin" action="changeCategoryDB.jsp" method="POST">
			  <h2 class="form-signin-heading">Change Category</h2>
			  ...
			  <input type="text" name="Name" id="inputName" class="form-control" placeholder="Books" required autofocus>
